...
public class myScribe extends JavaPlugin implements Listener {
	...
	private AutoCorrection[] default_AutoCorrections = { new AutoCorrection(" i ", " I "), new AutoCorrection(" ik ", " I know "), new AutoCorrection(" ib ", " I'm back "),
			...
			new AutoCorrection(" stfu ", " shut the fuck up "), new AutoCorrection(" btw ", " by the way "), new AutoCorrection(" i gtg ", " I have to go "),
			new AutoCorrection(" i g2g ", " I have to go "), new AutoCorrection(" igtg ", " I have to go "), new AutoCorrection(" ig2g ", " I have to go "),
			new AutoCorrection(" gtg ", " I have to go "), new AutoCorrection(" g2g ", " I have to go "), new AutoCorrection(" i stg ", " I swear to God "),
			new AutoCorrection(" i s2g ", " I swear to God "), new AutoCorrection(" istg ", " I swear to God "), new AutoCorrection(" is2g ", " I swear to God "),
			new AutoCorrection(" stg ", " I swear to God "), new AutoCorrection(" s2g ", " I swear to God "), new AutoCorrection(" 2nite ", " tonight "),
			new AutoCorrection(" l8", "late"), new AutoCorrection(" w8", " wait "), new AutoCorrection(" m8", " mate"), new AutoCorrection(" 4got ", " forgot "),
			new AutoCorrection(" 4get ", " forget "), new AutoCorrection(" i brb ", " I'll be right back "), new AutoCorrection(" ibrb ", " I'll be right back "),
			new AutoCorrection(" brb ", " I'll be right back "), new AutoCorrection(" nvm ", " never mind "), new AutoCorrection(" ppl ", " people "),
			new AutoCorrection(" nm ", " never mind "), new AutoCorrection(" tp ", " teleport "), new AutoCorrection(" tpa ", " teleport "),
			new AutoCorrection(" cuz ", " because "), new AutoCorrection(" plz ", " please "), new AutoCorrection(" ppl ", " people "),
			new AutoCorrection(" thx ", " thanks "), new AutoCorrection(" thnx ", " thanks "), new AutoCorrection(" xmas ", " Christmas "),
			new AutoCorrection(" becuz ", " because "), new AutoCorrection(" sry ", " sorry "), new AutoCorrection(" cm ", " Creative Mode "),
			new AutoCorrection(" cmp ", " Creative multiplayer "), new AutoCorrection(" sm ", " Survival Mode "), new AutoCorrection(" smp ", " Survival multiplayer "),
			new AutoCorrection(" im ", " I'm "), new AutoCorrection(" wont ", " won't "), new AutoCorrection(" didnt ", " didn't "), new AutoCorrection(" dont ", " don't "),
