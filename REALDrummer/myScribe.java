...
public class myScribe extends JavaPlugin implements Listener {
	...
	private AutoCorrection[] default_AutoCorrections = { new AutoCorrection(" i ", " I "), new AutoCorrection(" ik ", " I know "), new AutoCorrection(" ib ", " I'm back "),
			...
			new AutoCorrection(" lmk ", " let me know "), new AutoCorrection(" irl ", " in real life "), new AutoCorrection(" wtf ", " what the fuck? ", "?", false),
			new AutoCorrection(" wtf ", " what the fuck "), new AutoCorrection(" wth ", " what the hell? ", "?", false), new AutoCorrection(" wth ", " what the hell "),
			new AutoCorrection(" ftw ", " for the win "), new AutoCorrection(" y ", " why ", "=", false), new AutoCorrection(" u ", " you "),
			new AutoCorrection(" ur ", " your "), new AutoCorrection(" r ", " are "), new AutoCorrection(" o.o ", " \\o.\\o\\ "), new AutoCorrection(" o ", " oh "),
			...
			new AutoCorrection(" jk ", " just kidding "), new AutoCorrection(" jking ", " just kidding "), new AutoCorrection(" jkjk ", " just kidding "),
			new AutoCorrection(" np ", " no problem "), new AutoCorrection(" tmi ", " too much information "), new AutoCorrection(" afk ", " \\a.\\f.\\k. ", "/", true),
			new AutoCorrection(" \\a.\\f.\\k. .", " \\a.\\f.\\k."), new AutoCorrection(" omg ", " oh my God "), new AutoCorrection(" omfg ", " oh my fucking God "),
			new AutoCorrection(" stfu ", " shut the fuck up "), new AutoCorrection(" btw ", " by the way "), new AutoCorrection(" ul ", " upload "),
			new AutoCorrection(" dl ", " download "), new AutoCorrection(" i gtg ", " I have to go "), new AutoCorrection(" i g2g ", " I have to go "),
			new AutoCorrection(" igtg ", " I have to go "), new AutoCorrection(" ig2g ", " I have to go "), new AutoCorrection(" gtg ", " I have to go "),
			new AutoCorrection(" g2g ", " I have to go "), new AutoCorrection(" i stg ", " I swear to God "), new AutoCorrection(" i s2g ", " I swear to God "),
			new AutoCorrection(" istg ", " I swear to God "), new AutoCorrection(" is2g ", " I swear to God "), new AutoCorrection(" stg ", " I swear to God "),
			new AutoCorrection(" s2g ", " I swear to God "), new AutoCorrection(" 2nite ", " tonight "), new AutoCorrection(" l8", "late"),
			new AutoCorrection(" w8", " wait "), new AutoCorrection(" m8", " mate"), new AutoCorrection(" 4got ", " forgot "), new AutoCorrection(" 4get ", " forget "),
			new AutoCorrection(" i brb ", " I'll be right back "), new AutoCorrection(" ibrb ", " I'll be right back "), new AutoCorrection(" brb ", " I'll be right back "),
			new AutoCorrection(" nvm ", " never mind "), new AutoCorrection(" ppl ", " people "), new AutoCorrection(" nm ", " never mind "),
			new AutoCorrection(" tp ", " teleport "), new AutoCorrection(" tpa ", " teleport "), new AutoCorrection(" cuz ", " because "),
			new AutoCorrection(" plz ", " please "), new AutoCorrection(" ppl ", " people "), new AutoCorrection(" thx ", " thanks "),
			new AutoCorrection(" thnx ", " thanks "), new AutoCorrection(" xmas ", " Christmas "), new AutoCorrection(" becuz ", " because "),
			new AutoCorrection(" sry ", " sorry "), new AutoCorrection(" cm ", " Creative Mode "), new AutoCorrection(" cmp ", " Creative multiplayer "),
			new AutoCorrection(" sm ", " Survival Mode "), new AutoCorrection(" smp ", " Survival multiplayer "), new AutoCorrection(" im ", " I'm "),
			new AutoCorrection(" wont ", " won't "), new AutoCorrection(" didnt ", " didn't "), new AutoCorrection(" dont ", " don't "),
			new AutoCorrection(" cant ", " can't "), new AutoCorrection(" wouldnt ", " wouldn't "), new AutoCorrection(" shouldnt ", " shouldn't "),
			new AutoCorrection(" couldnt ", " couldn't "), new AutoCorrection(" isnt ", " isn't "), new AutoCorrection(" aint ", " ain't "),
			new AutoCorrection(" doesnt ", " doesn't "), new AutoCorrection(" youre ", " you're "), new AutoCorrection(" hes ", " he's "),
			new AutoCorrection(" shes ", " she's "), new AutoCorrection(" hed ", " he'd "), new AutoCorrection(" could of ", " could have "),
			new AutoCorrection(" should of ", "should have "), new AutoCorrection(" would of ", " would have "), new AutoCorrection(" itz ", " it's "),
			new AutoCorrection("wierd", "weird"), new AutoCorrection("recieve", "receive"), new AutoCorrection(" blowed up ", " blew up "),
			new AutoCorrection(" blowed it up ", " blew it up "), new AutoCorrection("!1", "!!"), new AutoCorrection("\".", ".\"", "\"", false) };
	...
	public void onEnable() {
		...
		// done enabling
		tellOps(ChatColor.BLUE + enable_messages[(int) (Math.random() * enable_messages.length)], true);
	}
	...
	public void onDisable() {
		...
		// done disabling
		tellOps(ChatColor.BLUE + disable_messages[(int) (Math.random() * disable_messages.length)], true);
	}
	...
	public boolean onCommand(CommandSender sender, Command cmd, String command, String[] my_parameters) {
		...
		// TODO add partial saves
			...
			tellOps(ChatColor.BLUE + sender_name + " added a new login message.\n\"" + colorCode(message) + ChatColor.BLUE + "\"", sender instanceof Player, sender.getName());
			return true;
			...
			if (sender instanceof Player && !sender.hasPermission("myscribe.mute"))
				...
				if (target == null)
					...
					sender.sendMessage(ChatColor.BLUE + target + " has been muted.");
					...
					tellOps(ChatColor.BLUE + sender_name + " muted " + target + ".", sender instanceof Player, sender.getName());
				}
			}
			return true;
			...
			if (sender instanceof Player && !sender.hasPermission("myscribe.unmute"))
				...
				if (target == null)
					...
					sender.sendMessage(ChatColor.BLUE + target + " has been unmuted.");
					tellOps(ChatColor.BLUE + sender_name + " unmuted " + target + ".", sender instanceof Player, sender.getName());
				}
			}
			return true;
			...
			if (sender instanceof Player && !sender.isOp())
				sender.sendMessage(ChatColor.RED + "Sorry, but you don't have permission to use " + ChatColor.BLUE + "/say" + ChatColor.RED + ".");
			else if (parameters.length == 0)
				...
				if (epithet == null)
					epithet = "&dGod";
				server.broadcastMessage(colorCode(replaceAll(default_message_format, "[epithet]", epithet, "[message]", AutoCorrect(sender, message))));
			}
			return true;
		}
		return false;
	...
	private String AutoCorrect(CommandSender sender, String message) {
		if (AutoCorrect_on && !message.startsWith("http") && !message.startsWith("www.")) {
			...
			// ...backslashes that are not part of an emoticon;...
					...
					|| message.endsWith(".....")
					// ...and random commas and greater than or less than signs.
					|| message.endsWith(",") || message.endsWith(">") || message.endsWith("<"))
			...
			if (message.length() > 1)
				for (int i = 1; i < message.length(); i++) {
					String char0 = message.substring(i - 1, i), char1 = message.substring(i, i + 1);
					// temporarily separate two characters with a space for AutoCorrections if...
					if (// ...one is a number or letter and the other is not;...
					(!isNumberOrLetter(char0) && isNumberOrLetter(char1) || isNumberOrLetter(char0) && !isNumberOrLetter(char1) || char0.equals(".")
							&& !isNumberOrLetter(char1))
							// ...neither character is one of special punctuation marks that can be enclosed inside words or a space;...
							&& !contains(do_not_add_spaces_chars, char0)
							&& !contains(do_not_add_spaces_chars, char1)
							// ...the non-letter/number is not a period in an abbreviation, hyperlink, or decimal;...
							&& !(char0.equals(".") && (isNumberOrLetter(char1) || char1.equals(" ") && i >= 3 && message.substring(i - 3, i - 2).equals(".")))
							&& !(char1.equals(".") && (message.length() >= i + 2 && isNumberOrLetter(message.substring(i + 1, i + 2)) || i >= 2
									&& message.substring(i - 2, i - 1).equals(".")))
							// ...the non-letter/number is not a comma in a number;...
							&& !(char0.equals(",") && (isNumberOrLetter(char1) && char1.toLowerCase().equals(char1.toUpperCase()) || i >= 2
							...
							&& !(char1.equals(",") && (message.length() >= i + 2 && isNumberOrLetter(message.substring(i + 1, i + 2))
									&& char1.toLowerCase().equals(message.substring(i + 1, i + 2).toUpperCase()) || isNumberOrLetter(message.substring(i - 1, i))
									&& char0.toLowerCase().equals(char0.toUpperCase())))
							// ...the two characters aren't an emoticon;...
							&& !((char0.equals(":") || char0.equals(";") || char0.equals("=")) && (i + 1 >= message.length() || message.substring(i + 1, i + 2).equals(" ")))
							&& !(char0 + char1).equals("<3")
							// ...and the two characters aren't a color code.
							&& !isColorCode(char0 + char1, null, null))
			...
			if (change_all_caps_to_italics && !message.startsWith("*") && !message.endsWith("*")) {
				for (int i = 0; i < words.length; i++) {
					...
					if (
					// ...EITHER the word is longer than one letter and not an abbreviation OR the word before it is italicized;...
					(word.length() > 1 && replaceAll(word, ".", "").length() * 2 != word.length() || i > 0 && words[i - 1].toLowerCase().contains("&o"))
							...
							// ...the word doesn't have a length of two and start or end with an "X", ":", ";", or "=" (emoticons);...
							&& (word.length() != 2 || !(word.startsWith("X") || word.endsWith("X") || word.startsWith(":") || word.endsWith(":") || word.startsWith(";")
									|| word.endsWith(";") || word.startsWith("=") || word.endsWith("=")))
						...
						if (i == words.length - 1 && !word.endsWith(".") && !word.endsWith("!") && !word.endsWith("?") && !word.endsWith(".\"") && !word.endsWith("!\"")
							...
							if (words[i].endsWith("\""))
								...
								words[i] = words[i] + "!";
						words[i] = "&o" + words[i] + "%o";
						// only change the word to lower case if it's not an acronym
			...
			if (capitalize_first_letter && !message.startsWith("*") && !message.endsWith("*")) {
				...
				for (int i = 0; i < message.length(); i++) {
					...
					if ((message.substring(i, i + 1).equals(".")
							&& !(message.length() > i + 1 && isNumberOrLetter(message.substring(i + 1, i + 2)) && !(message.length() > i + 2 && message
									.substring(i + 2, i + 3).equals("."))) || message.substring(i, i + 1).equals("!") || message.substring(i, i + 1).equals("?"))
	...
	public void cancelMutedPlayersChatOrFormatMessage(AsyncPlayerChatEvent event) {
		...
		// if it's a chat message
			...
			event.setFormat(colorCode(replaceAll(default_message_format, "[player]", event.getPlayer().getName(), "[epithet]", epithet, "[message]", AutoCorrect(event
					.getPlayer(), full_chat_message))));
				...
				if (save_line.startsWith("====") && save_line.endsWith("====")) {
					...
					if (save_line.startsWith("++") && save_line.endsWith("++")) {
						...
						if (save_line.endsWith("++")) {
							save_line = save_line.substring(0, save_line.length() - 2).trim() + "++";
						}
					}
	...
	private void getRecipe(CommandSender sender) {
		...
		String recipe = myPluginWiki.getRecipe(id, data), item_name = myPluginWiki.getItemName(id, data, false, false, false);
		if (recipe != null)
	...
	private void id(CommandSender sender) {
		if (parameters.length == 0 || parameters[0].equalsIgnoreCase("this") || parameters[0].equalsIgnoreCase("that"))
			if (sender instanceof Player) {
				...
				String item_name = myPluginWiki.getItemName(id, data, false, true, true), id_and_data = String.valueOf(id);
				...
				item_name = myPluginWiki.getItemName(id, data, false, true, true);
				// take out the first word, which is an article
				// item_name = item_name.substring(item_name.indexOf(' ') + 1);
			...
			try {
				...
				String item_name = myPluginWiki.getItemName(id, -1, true, false, false);
				if (item_name != null)
					if (!item_name.startsWith("some") || (item_name.endsWith("s") && !item_name.endsWith("ss")))
				...
				try {
					...
					if (temp.length == 2) {
						...
						String item_name = myPluginWiki.getItemName(id, data, true, false, false), id_and_data = String.valueOf(id);
						if (data > 0)
							id_and_data += ":" + data;
						// send the message
						if (item_name != null)
						...
						// item name.
						String item_name = myPluginWiki.getItemName(id_and_data[0], id_and_data[1], false, false, false), id_and_data_term = String.valueOf(id_and_data[0]);
						if (id_and_data[1] > 0)
