...
public class myScribe extends JavaPlugin implements Listener {
	...
	private static final String[] enable_messages = { "The pen is mightier than the pixelated diamond sword.",
			...
			borders = { "[]", "\\/", "\"*", "_^", "-=", ":;", "&%", "#@", ",.", "<>", "~$", ")(" }, yeses = { "yes", "yeah", "yep", "ja", "sure", "why not", "okay", "do it",
					...
					"no don't", "shut up", "ignore", "it's not", "its not", "creeper", "unsafe", "wait", "one ", "1 " }, recipes = { null, null, null, null,
					"Just craft any kind of wood (logs).", null, null, null, null, null, null, null, null, null, null, null, null, null, null, "Melt sand in a furnace.",
					null, "&1lapis lazuli\nLLL\nLLL\nLLL", "&8cobblestone&f, bow, &4redstone dust\n&8CCC\nC&fB&8C\nC&4R&8C", "&esand\n&0---\n-&eSS\n&0-&eSS",
					"&4redstone dust\n&e&m&nWWW\nW&4R&e&m&nW\nWWW", "wool, &e&m&nwooden planks\n&0---\n&fWWW\n&e&m&nWWW",
					"&6gold&f, &e&msticks&f, &4redstone dust\n&6G&0-&6G\nG&f&e&mS&6G\nG&4R&6G",
					"&7iron ingots&f, &8&nstone pressure plate&f, &4redstone dust\n&7I&0-&7I\nI&8&nS&7I\nI&4R&7I", "&aslimeballs&f, &e&npistons\n&0---\n-&aS&0-\n-&e&nP&0-",
					null, null, null, "&e&m&nwooden planks&f, &8cobblestone&f, &7iron ingots&f, &4redstone dust\n&e&m&nWWW\n&8C&7I&8C\nC&4R&8C", null,
	...
	private AutoCorrection[] default_AutoCorrections =
			{ new AutoCorrection(" i ", " I ", null, true, null), new AutoCorrection(" ik ", " I know ", null, true, null),
					new AutoCorrection(" ib ", " I'm back ", null, true, null), new AutoCorrection(" ic ", " I see ", null, true, null),
					new AutoCorrection(" tp ", " teleport ", null, false, null), new AutoCorrection(" idk ", " I don't know ", null, true, null),
					new AutoCorrection(" idc ", " I don't care ", null, true, null), new AutoCorrection(" ikr ", " I know, right? ", "?", false, null),
					new AutoCorrection(" ikr ", " I know, right ", null, true, null), new AutoCorrection(" irl ", " in real life ", null, true, null),
					new AutoCorrection(" wtf ", " what the fuck? ", "?", false, null), new AutoCorrection(" wtf ", " what the fuck ", null, true, null),
					new AutoCorrection(" wth ", " what the hell? ", "?", false, null), new AutoCorrection(" wth ", " what the hell ", null, true, null),
					new AutoCorrection(" ftw ", " for the win ", null, true, null), new AutoCorrection(" y ", " why ", "=", false, null),
					new AutoCorrection(" u ", " you ", null, true, null), new AutoCorrection(" ur ", " your ", null, true, null),
					new AutoCorrection(" r ", " are ", null, true, null), new AutoCorrection(" o . o ", " \\o.\\o\\ ", null, true, null),
					new AutoCorrection(" o ", " oh ", null, true, null), new AutoCorrection(" c ", " see ", null, true, null),
					new AutoCorrection(" k ", " okay ", null, true, null), new AutoCorrection(" kk ", " okay ", null, true, null),
					new AutoCorrection(" ic ", " I see ", null, true, null), new AutoCorrection(" cya ", " see ya ", null, true, null),
					new AutoCorrection(" sum1", " someone ", null, true, null), new AutoCorrection(" some1", " someone ", null, true, null),
					new AutoCorrection("every1", "everyone", null, true, null), new AutoCorrection("any1", "anyone", null, true, null),
					new AutoCorrection(" ttyl ", " I'll talk to you later ", null, true, null), new AutoCorrection(" wb ", " welcome back ", null, true, null),
					new AutoCorrection(" ty ", " thank you ", null, true, null), new AutoCorrection(" yw ", " you're welcome ", null, true, null),
					new AutoCorrection(" gb ", " goodbye ", null, true, null), new AutoCorrection(" hb ", " happy birthday ", null, true, null),
					new AutoCorrection(" gl ", " good luck ", null, true, null), new AutoCorrection(" jk ", " just kidding ", null, true, null),
					new AutoCorrection(" jking ", " just kidding ", null, true, null), new AutoCorrection(" jkjk ", " just kidding ", null, true, null),
					new AutoCorrection(" np ", " no problem ", null, true, null), new AutoCorrection(" tmi ", " too much information ", null, true, null),
					new AutoCorrection(" afk ", " \\a.\\f.\\k. ", "/", true, null), new AutoCorrection(" \\a.\\f.\\k. .", " \\a.\\f.\\k.", null, true, null),
					new AutoCorrection(" omg ", " oh my God ", null, true, null), new AutoCorrection(" omfg ", " oh my fucking God ", null, true, null),
					new AutoCorrection(" stfu ", " shut the fuck up ", null, true, null), new AutoCorrection(" btw ", " by the way ", null, true, null),
					new AutoCorrection(" i gtg ", " I have to go ", null, true, null), new AutoCorrection(" i g2g ", " I have to go ", null, true, null),
					new AutoCorrection(" igtg ", " I have to go ", null, true, null), new AutoCorrection(" ig2g ", " I have to go ", null, true, null),
					new AutoCorrection(" gtg ", " I have to go ", null, true, null), new AutoCorrection(" g2g ", " I have to go ", null, true, null),
					new AutoCorrection(" 2nite ", " tonight ", null, true, null), new AutoCorrection(" l8", "late", null, true, null),
					new AutoCorrection(" w8", " wait ", null, true, null), new AutoCorrection(" m8", " mate", null, true, null),
					new AutoCorrection(" 4got ", " forgot ", null, true, null), new AutoCorrection(" 4get ", " forget ", null, true, null),
					new AutoCorrection(" i brb ", " I'll be right back ", null, true, null), new AutoCorrection(" ibrb ", " I'll be right back ", null, true, null),
					new AutoCorrection(" brb ", " I'll be right back ", null, true, null), new AutoCorrection(" nvm ", " never mind ", null, true, null),
					new AutoCorrection(" ppl ", " people ", null, true, null), new AutoCorrection(" nm ", " never mind ", null, true, null),
					new AutoCorrection(" tp ", " teleport ", null, true, null), new AutoCorrection(" tpa ", " teleport ", null, true, null),
					new AutoCorrection(" cuz ", " because ", null, true, null), new AutoCorrection(" plz ", " please ", null, true, null),
					new AutoCorrection(" ppl ", " people ", null, true, null), new AutoCorrection(" thx ", " thanks ", null, true, null),
					new AutoCorrection(" thnx ", " thanks ", null, true, null), new AutoCorrection(" xmas ", " Christmas ", null, true, null),
					new AutoCorrection(" becuz ", " because ", null, true, null), new AutoCorrection(" sry ", " sorry ", null, true, null),
					new AutoCorrection(" cm ", " Creative Mode ", null, true, null), new AutoCorrection(" cmp ", " Creative multiplayer ", null, true, null),
					new AutoCorrection(" sm ", " Survival Mode ", null, true, null), new AutoCorrection(" smp ", " Survival multiplayer ", null, true, null),
					new AutoCorrection(" im ", " I'm ", null, true, null), new AutoCorrection(" wont ", " won't ", null, true, null),
					new AutoCorrection(" didnt ", " didn't ", null, true, null), new AutoCorrection(" dont ", " don't ", null, true, null),
					new AutoCorrection(" cant ", " can't ", null, true, null), new AutoCorrection(" wouldnt ", " wouldn't ", null, true, null),
					new AutoCorrection(" shouldnt ", " shouldn't ", null, true, null), new AutoCorrection(" couldnt ", " couldn't ", null, true, null),
					new AutoCorrection(" isnt ", " isn't ", null, true, null), new AutoCorrection(" aint ", " ain't ", null, true, null),
					new AutoCorrection(" doesnt ", " doesn't ", null, true, null), new AutoCorrection(" youre ", " you're ", null, true, null),
					new AutoCorrection(" hes ", " he's ", null, true, null), new AutoCorrection(" shes ", " she's ", null, true, null),
					new AutoCorrection(" hed ", " he'd ", null, true, null), new AutoCorrection(" could of ", " could have ", null, true, null),
					new AutoCorrection(" should of ", "should have ", null, true, null), new AutoCorrection(" would of ", " would have ", null, true, null),
					new AutoCorrection(" itz ", " it's ", null, true, null), new AutoCorrection("wierd", "weird", null, true, null),
					new AutoCorrection("recieve", "receive", null, true, null), new AutoCorrection(" blowed up ", " blew up ", null, true, null),
					new AutoCorrection(" blowed it up ", " blew it up ", null, true, null), new AutoCorrection(" RAM ", " \\RAM ", null, true, null),
					new AutoCorrection(" NASA ", " \\NASA ", null, true, null), new AutoCorrection(" Xbox LIVE ", " Xbox \\LIVE ", null, true, null),
					new AutoCorrection(" AIDS ", " \\AIDS ", null, true, null), new AutoCorrection("!1", "!!", null, true, null),
	...
	private static ArrayList<String> AFK_players = new ArrayList<String>(), players_who_have_accepted_the_rules = new ArrayList<String>(),
	...
	public boolean onCommand(CommandSender sender, Command cmd, String command, String[] my_parameters) {
		...
		// TODO add partial saves
			...
			if (!(sender instanceof Player) || sender.isOp()) {
				...
				server.broadcastMessage(colorCode(replace(say_format, "[message]", AutoCorrect(sender, message), null, true, false)));
			} else
		...
		if (AutoCorrect_on && !message.startsWith("http") && !message.startsWith("www.") && !message.startsWith("*") && !message.endsWith("*")) {
			...
			if (message.length() > 1)
				for (int i = 1; i < message.length(); i++)
					if ((!message.substring(i, i + 1).toLowerCase().equals(message.substring(i, i + 1).toUpperCase()) || message.substring(i, i + 1).equals("0")
			...
			for (AutoCorrection correction : AutoCorrections)
				if (!(sender instanceof Player)
						...
						|| (correction.target.startsWith("\\[") && correction.target.endsWith("\\]") && (permissions != null && correction.target.substring(1,
								correction.target.length() - 1).equals(permissions.getPrimaryGroup((Player) sender))))
						|| ((!correction.target.startsWith("\\[") || !correction.target.endsWith("\\]")) && sender.getName().equals(correction.target)))
					message = replace(message, correction.to_correct, correction.to_correct_to, correction.unless, correction.before, true);
			...
			if (change_all_caps_to_italics) {
				for (int i = 0; i < words.length; i++) {
					...
					// make the changes if, respectively, the word is longer than one letter (or the word before or after it is italicized); there are no
					// underscores (found in usernames or emoticons); it doesn't have a length of two and start with or and with an X, a colon, a semicolon, or
					// an equals sign (emoticons); the words is all caps (of course); and the word is not in an abbreviation
					if ((temp.length() > 1 || (i > 0 && words[i - 1].toLowerCase().contains("&o")) || (i < words.length - 1 && words[i + 1].toLowerCase().contains("&o")))
							&& !temp.contains("_")
							&& !temp.contains("\\")
						...
						if (i > 0 && words[i - 1].length() == 1 && words[i - 1].toUpperCase().equals(words[i - 1]) && !words[i - 1].toLowerCase().equals(words[i - 1])) {
				...
				if (message.substring(i, i + 1).toLowerCase().equals(message.substring(i, i + 1).toUpperCase())
					...
					try {
						...
						if (!message.substring(i, i + 1).equals("(") && !message.substring(i, i + 1).equals("[") && !message.substring(i, i + 1).equals("{")
							...
							int end_index = i + 1;
							while (end_index < message.length()
									&& (!message.substring(end_index, end_index + 1).toUpperCase().equals(message.substring(end_index, end_index + 1).toLowerCase())
											|| message.substring(end_index, end_index + 1).equals("0") || message.substring(end_index, end_index + 1).equals("1")
											|| message.substring(end_index, end_index + 1).equals("2") || message.substring(end_index, end_index + 1).equals("3")
											|| message.substring(end_index, end_index + 1).equals("4") || message.substring(end_index, end_index + 1).equals("5")
											|| message.substring(end_index, end_index + 1).equals("6") || message.substring(end_index, end_index + 1).equals("7")
											|| message.substring(end_index, end_index + 1).equals("8") || message.substring(end_index, end_index + 1).equals("9")))
								end_index++;
	...
	public void cancelMutedPlayersChatOrFormatMessage(AsyncPlayerChatEvent event) {
		...
		// if it is a chat
			...
			event.setMessage(colorCode(replace(replace(replace(default_message_format, "[player]", event.getPlayer().getName(), null, true, true), "[epithet]", epithet, null,
					true, false), "[message]", AutoCorrect(event.getPlayer(), full_chat_message), null, true, false)));
		} else {
	...
	public void onLogin(PlayerJoinEvent event) {
		...
		if (!event.getPlayer().isOp() && players_must_accept_rules && !players_who_have_accepted_the_rules.contains(event.getPlayer().getName()))
			...
			// TODO display all the announcements they haven't read
		}
	}
	...
	private void loadTheAnnouncements(CommandSender sender) {
		...
		// default expiration times: 4 weeks (2,419,200,000ms) for important ones, 2 weeks (1,209,600,000ms) for normal ones, and 1 week (604,800,000ms) for
		// unimportant ones
		...
		try {
			...
			while (save_line != null) {
				if (save_line.startsWith("expiration time for important announcements:"))
					...
					// check to see if the announcement has expired already and if not, and if it hasn't, add it and schedule an event to cancel it later
					if (read_announcement.time_created + expiration_times_for_announcements[read_announcement.is_important_index] > Calendar.getInstance().getTimeInMillis()) {
						...
						server.getScheduler().scheduleSyncDelayedTask(this,
								...
								}, // divide by 50 because the scheduler schedules 1 tick/20 seconds; ms*1s/1000ms*20ticks/s = ms*20/1000 = ms/50
			...
			while (save_line != null) {
				if (isBorder(save_line)) {
					...
					if (save_line.contains(", ")) {
						...
						// elimiate the "and" and sentence ending around the last username
			...
			try {
				...
				while (save_line != null) {
					if (save_line.startsWith("==== "))
						...
						// in the case of mail, "commander" actually represents the recipient of the mail
	...
	private void saveTheTemporaryData() {
		// ^that warning suppression is for the part were I cast an Object, data[2], as an ArrayList<String> without a check
		// check the temporary file
		File temp_file = new File(getDataFolder(), "temp.txt");
	...
	private void getRecipe(CommandSender sender) {
		...
		if (Wiki.getRecipe(id, data) != null)
			...
			sender.sendMessage(ChatColor.BLUE + "You can't craft a " + Wiki.getItemName(id, data, false) + "!");
	...
	private void id(CommandSender sender) {
		if (parameters.length == 0 || parameters[0].equalsIgnoreCase("this") || parameters[0].equalsIgnoreCase("that"))
			if (sender instanceof Player) {
				...
				String item_name = Wiki.getItemName(id, ((Player) sender).getTargetBlock(null, 1024).getData(), false);
				if (item_name != null)
					if (item_name.endsWith("s") && !item_name.endsWith("ss"))
						sender.sendMessage(ChatColor.GRAY + "Those " + item_name + " you're pointing at have the I.D. " + id + ".");
					else
						sender.sendMessage(ChatColor.GRAY + "That " + item_name + " you're pointing at has the I.D. " + id + ".");
				else
					sender.sendMessage(ChatColor.RED + "Uh...what in the world " + ChatColor.ITALIC + "is" + ChatColor.RED + " that thing you're pointing at?");
				item_name = Wiki.getItemName(((Player) sender).getItemInHand().getTypeId(), ((Player) sender).getItemInHand().getData().getData(), false);
				if (item_name != null)
					if (item_name.endsWith("s") && !item_name.endsWith("ss"))
						sender.sendMessage(ChatColor.GRAY + "Those " + item_name + " you're holding have the I.D. " + id + ".");
					else
						sender.sendMessage(ChatColor.GRAY + "That " + item_name + " you're holding has the I.D. " + id + ".");
				else
			...
			try {
				...
				// this part seems odd because it seems like it's a long roundabout way to get item_name. You might think: isn't item_name the same as query?
				// Wrong. A query can (and probably is) just a few letters from the name of the item. By finding the id, then using that to get the name, it's
				// an effective autocompletion of the item name
				String item_name = Wiki.getItemName(id_and_data[0], id_and_data[1], false);
